...
# Open the video file
#video_path = "C:/Users/Admin/PythonLession/YoloV8/pic/traffic-4ways.mp4"
#video_path="d.mp4"
...
START = [sv.Point(300, 700)]
END = [sv.Point(1100, 500)]
...
while cap.isOpened():
    ...
    if success:
        ...
        if results[0].boxes.id != None:
            ...
            track_ids = results[0].boxes.id.cuda().tolist()
            ...
            cv2.rectangle(annotated_frame, (int(x - w / 2), int(y - h / 2)), (int(x + w / 2), int(y + h / 2)), (250, 255,22 ),2)
