...
cap = cv2.VideoCapture('C:/Users/Admin/PythonLession/pic/marathon.mp4')
...
obcross = 2 # 8 pxel, when object near the line, calculator start couting


# Define the line coordinates
START = [sv.Point(378, 626)]
END = [sv.Point(890, 618)]
